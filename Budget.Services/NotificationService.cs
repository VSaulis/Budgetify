...
namespace Budget.Services
{
    public class NotificationService : INotificationService
    {
        ...
        public async Task<ListResponse<NotificationDto>> ListAsync(ListNotificationsRequest request)
        {
            ...
            var filter = new NotificationsFilter {ReceiverId = loggedUser.User.Id};
            ...
            var notificationsDtosList = _mapper.Map<List<Notification>, List<NotificationDto>>(notifications);
            return new ListResponse<NotificationDto>(notificationsDtosList, notificationsCount);
        }
